...
from deeplab_resnet import MyDeepLabResNetModel, ImageReader, decode_labels, inv_preprocess, prepare_label

IMG_MEAN = np.array((104.00698793,116.66876762,122.67891434), dtype=np.float32)

BATCH_SIZE = 1
DATA_DIRECTORY = '/home/pengjf/Dataset/VOC2012'
DATA_LIST_PATH = './dataset/train_car.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '321,321'
LEARNING_RATE = 2.5e-3
MOMENTUM = 0.9
NUM_CLASSES = 2
NUM_STEPS = 121*10000+1
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = None
SAVE_NUM_IMAGES = 1
SAVE_PRED_EVERY = 121*100
...
def main():
    ...
    # Create network.
    net = MyDeepLabResNetModel({'data': image_batch}, is_training=args.is_training, num_classes=args.num_classes)
    ...
    reduced_loss_ = tf.reduce_mean(loss) + tf.add_n(l2_losses)
    ...
    loss_summary_reduced_loss = tf.summary.scalar("reduced_loss", reduced_loss_)
